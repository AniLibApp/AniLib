...
class PatreonInfoBinder(binderAdapter: AppInfoAdapter) :
    DynamicRecyclerViewBinder<PatreonInfoBinder.ViewHolder>(binderAdapter) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            (dynamicInfoView.linksView.adapter as? DynamicItemsAdapter)?.dataSet?.forEach {
