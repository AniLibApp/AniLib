...
class DiscoverMediaShowcaseLayout : LinearLayout {
    ...
    val popularityTv: DynamicDrawableTextView
    val favouriteTv: DynamicDrawableTextView
    ...
    constructor(context: Context, attributeSet: AttributeSet?) : super(context, attributeSet) {
        ...
        constraintSet.connect(titleTv.id, ConstraintSet.END, constraintLayout.id, ConstraintSet.END)
        constraintSet.connect(titleTv.id, ConstraintSet.TOP, descriptionTv.id, ConstraintSet.BOTTOM)
        constraintSet.connect(titleTv.id, ConstraintSet.BOTTOM, favouriteTv.id, ConstraintSet.TOP)
