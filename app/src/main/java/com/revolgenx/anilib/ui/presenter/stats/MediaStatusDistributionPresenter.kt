...
import com.revolgenx.anilib.data.model.user.stats.MediaStatsStatusDistributionModel
...
class MediaStatusDistributionPresenter(context: Context):BasePresenter<StatusDistributionLayoutBinding, MediaStatsStatusDistributionModel>(context) {
    ...
    override fun onBind(
        page: Page,
        holder: Holder,
        element: Element<MediaStatsStatusDistributionModel>
    ) {
