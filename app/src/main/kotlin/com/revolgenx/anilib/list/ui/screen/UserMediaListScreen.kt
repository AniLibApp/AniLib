...
@Composable
private fun AnimeListContent(userId: Int?, showSearchBar: Boolean, hideSearchBar: onMediaClick) {
...
@Composable
private fun MangaListContent(userId: Int?, showSearchBar: Boolean, hideSearchBar: onMediaClick) {
