...
import com.revolgenx.anilib.common.data.store.BasePreferenceDataModel
...
sealed class PreferenceModel {
    ...
    data class SwitchPreference(
        val pref: BasePreferenceDataModel<Boolean>? = null,
    ...
    data class ListPreferenceModel<T>(
        val pref: BasePreferenceDataModel<T>? = null,
