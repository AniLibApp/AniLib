...
public val AppIcons.IcNotificationOutline: ImageVector
    get() {
        if (_icNotificationOutline != null) {
            return _icNotificationOutline!!
        }
        _icNotificationOutline = Builder(
            name = "IcNotificationOutline", defaultWidth = 24.0.dp,
...
private var _icNotificationOutline: ImageVector? = null
