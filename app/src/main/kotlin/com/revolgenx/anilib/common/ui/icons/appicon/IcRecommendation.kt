...
public val AppIcons.IcRecommendation: ImageVector
    get() {
        if (_icRecommendation != null) {
            return _icRecommendation!!
        }
        _icRecommendation = Builder(
            name = "IcRecommendation", defaultWidth = 24.0.dp, defaultHeight
...
private var _icRecommendation: ImageVector? = null
