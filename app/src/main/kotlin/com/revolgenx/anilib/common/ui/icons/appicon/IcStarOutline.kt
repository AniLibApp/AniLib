...
public val AppIcons.IcStarOutline: ImageVector
    get() {
        if (_icStarOutline != null) {
            return _icStarOutline!!
        }
        _icStarOutline = Builder(
            name = "IcStarOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icStarOutline: ImageVector? = null
