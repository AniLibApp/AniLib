...
public val AppIcons.IcHeartOutline: ImageVector
    get() {
        if (_icHeartOutline != null) {
            return _icHeartOutline!!
        }
        _icHeartOutline = Builder(
            name = "IcHeartOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icHeartOutline: ImageVector? = null
