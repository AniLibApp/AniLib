...
public val AppIcons.IcQuestionMark: ImageVector
    get() {
        if (_icQuestionMark != null) {
            return _icQuestionMark!!
        }
        _icQuestionMark = Builder(
            name = "IcQuestionMark", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icQuestionMark: ImageVector? = null
