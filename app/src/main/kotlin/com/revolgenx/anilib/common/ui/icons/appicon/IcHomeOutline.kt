...
public val AppIcons.IcHomeOutline: ImageVector
    get() {
        if (_icHomeOutline != null) {
            return _icHomeOutline!!
        }
        _icHomeOutline = Builder(
            name = "IcHomeOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(
                ...
                moveTo(244.0f, 756.0f)
                lineTo(360.0f, 756.0f)
                lineTo(360.0f, 517.5f)
                lineTo(600.0f, 517.5f)
                lineTo(600.0f, 756.0f)
                lineTo(716.0f, 756.0f)
                lineTo(716.0f, 401.0f)
                lineTo(480.0f, 224.0f)
                lineTo(244.0f, 401.0f)
                lineTo(244.0f, 756.0f)
                close()
                ...
                lineTo(525.0f, 831.0f)
                lineTo(525.0f, 592.5f)
                lineTo(435.0f, 592.5f)
                lineTo(435.0f, 831.0f)
...
private var _icHomeOutline: ImageVector? = null
