...
public val AppIcons.IcPrivacyPolicy: ImageVector
    get() {
        if (_icPrivacyPolicy != null) {
            return _icPrivacyPolicy!!
        }
        _icPrivacyPolicy = Builder(
            name = "IcPrivacyPolicy", 
    ...
    private var _icPrivacyPolicy: ImageVector? = null

    @Preview
    @Composable
    private fun Preview() {
        Box(modifier = Modifier.padding(12.dp)) {
            Image(imageVector = AppIcons.IcPrivacyPolicy, contentDescription = "")
        }
    }
